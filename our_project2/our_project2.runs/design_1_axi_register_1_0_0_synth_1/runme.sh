...
HD_PWD='D:/micropc_project1/our_project2/our_project2.runs/design_1_axi_register_1_0_0_synth_1'
cd "$HD_PWD"
...
EAStep vivado -log design_1_axi_register_1_0_0.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source design_1_axi_register_1_0_0.tcl
